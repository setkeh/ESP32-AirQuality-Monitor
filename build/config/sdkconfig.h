...
#define CONFIG_PROJECT_NAME "ESP32-Template-Project"
#define CONFIG_WIFI_SSID "SETKEH"
#define CONFIG_WIFI_PASSWORD "Amberjayde1"
#define CONFIG_FIRMWARE_UPGRADE_JSON_URL "https://web.local.setkeh.com/firmware.json"
